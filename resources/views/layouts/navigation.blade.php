<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="text-amber-700 dark:text-amber-400 font-bold text-lg">☕ Coffee</a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-3">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400">
                    @php
                        ...
                        elseif ($hour < 17) $greeting = '☀️ Good Afternoon';
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('product.index')" :active="request()->routeIs('product.*')">☕ Products</x-responsive-nav-link>
        </div>
